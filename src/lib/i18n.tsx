...
const fi: Dict = {
  ...
  "admin.emailHint": "Useampi osoite pilkulla: myynti@…, varasto@…. Vercelissä RESEND_API_KEY; ilman avainta tilaus tallentuu mutta posti ei lähde.",
  "admin.vatRate": "ALV-%",
...
const en: Dict = {
  ...
  "admin.emailHint": "Several addresses, comma-separated. On Vercel set RESEND_API_KEY; without it the order is stored but not emailed.",
  "admin.vatRate": "VAT %",
